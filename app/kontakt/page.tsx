...
export const metadata: Metadata = {
  ...
  description:
    "Kontaktieren Sie uns für Fragen zu Elumalab, unserer KI-gestützten Plattform für Kundenkommunikation. Wir helfen Ihnen gerne weiter!",
      ...
      <header className="bg-gradient-to-r from-pink-500 via-orange-400 to-yellow-300 py-16 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-xl text-white mb-8 max-w-3xl mx-auto animate-slide-up-delay">
            Wir freuen uns, von Ihnen zu hören. Kontaktieren Sie uns für Fragen, Feedback oder Unterstützung.
          </p>
        </div>
      </header>
            ...
            <div className="grid md:grid-cols-2 gap-12">
                ...
                <div className="bg-gray-50 p-6 rounded-lg border border-gray-200 mt-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start">
                      ...
                      <p className="text-gray-700">Individuelle Anpassungen für Ihr Unternehmen</p>
                    </div>
                    <div className="flex items-start">
                      <Clock className="h-5 w-5 text-pink-500 mr-2 flex-shrink-0 mt-0.5" />
                      <p className="text-gray-700">Schnelle Antworten auf all Ihre Fragen</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <form className="space-y-4">
                  ...
                  {/* Versteckte Felder für E-Mail-Routing */}
