...
export const metadata: Metadata = {
  title: "Preise | Elumalab WhatsApp Business Plattform",
  description:
    "Transparente Preise für alle Unternehmen. Wählen Sie das Paket, das am besten zu Ihren Bedürfnissen passt und revolutionieren Sie Ihre Kundenkommunikation.",
  keywords:
    "Elumalab Preise, WhatsApp Business Preise, KI-Chatbot Kosten, Messaging Plattform Kosten, WhatsApp API Preise",
  openGraph: {
    title: "Preise | Elumalab WhatsApp Business Plattform",
    description:
      "Transparente Preise für alle Unternehmen. Wählen Sie das Paket, das am besten zu Ihren Bedürfnissen passt.",
    images: [{ url: "/images/elumalab-pricing-og.jpg", width: 1200, height: 630 }],
  },
}
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-8">
              <FaqItem
                ...
                answer="Ja, Sie können Elumalab 14 Tage lang kostenlos testen. Keine Kreditkarte erforderlich. Nach Ablauf der Testphase können Sie sich für ein Paket entscheiden oder Ihr Konto wird automatisch auf die kostenlose Version herabgestuft."
              />

              <FaqItem
                question="Kann ich mein Paket jederzeit wechseln?"
                answer="Ja, Sie können jederzeit zu einem höheren Paket upgraden. Ein Downgrade ist zum Ende Ihrer aktuellen Abrechnungsperiode möglich. Alle Änderungen werden sofort wirksam und die Kosten anteilig berechnet."
              />
              ...
              <FaqItem
                ...
                answer="Nein, bei Elumalab gibt es keine versteckten Kosten. Alle Funktionen und Limits sind transparent in den Paketbeschreibungen aufgeführt. Bei Fragen steht Ihnen unser Support-Team gerne zur Verfügung."
              />

              <FaqItem
                question="Wie funktioniert der KI-Chatbot?"
                answer="Unser KI-Chatbot lernt aus Ihren bisherigen Kundeninteraktionen und kann häufig gestellte Fragen automatisch beantworten. Sie behalten die volle Kontrolle und können jederzeit eingreifen. Die KI wird kontinuierlich besser, je mehr sie genutzt wird."
              />
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl mb-10 text-white">
              Starten Sie jetzt mit Elumalab und erleben Sie den Unterschied in Ihrer Kundenkommunikation.
            </p>
