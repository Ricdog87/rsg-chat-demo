...
export const metadata: Metadata = {
  title: "Über uns | Elumalab",
  description:
    "Erfahre mehr über Elumalab, unsere Mission und das Team hinter der innovativen KI-gestützten Kommunikationsplattform.",
      ...
      <header className="bg-gradient-to-r from-pink-500 via-orange-400 to-yellow-300 py-16 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-xl text-white mb-8 max-w-3xl mx-auto animate-slide-up-delay">
            Erfahre mehr über Elumalab, unsere Mission und das Team hinter der innovativen KI-gestützten
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-700 mb-8 max-w-3xl mx-auto">
              Wir glauben, dass persönliche Kommunikation der Schlüssel zum Geschäftserfolg ist. Mit Elumalab machen wir
              diese persönliche Kommunikation effizienter, effektiver und zugänglicher für Unternehmen jeder Größe.
            </p>
